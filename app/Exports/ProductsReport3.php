...
class ProductsReport3 implements FromCollection, WithHeadings, WithStyles, WithColumnFormatting, ShouldAutoSize,WithStrictNullComparison
{
    /**
    ...
    */
    ...
    public function collection()
    {
        return $productos =  DB::table('productos as p')
            ...
            DB::raw('group_concat(c.categoria) as categorias'), DB::raw('(SELECT COUNT(codigo) from producto_codigos where producto_id = p.producto_id AND estado = 1) as codigos') )
