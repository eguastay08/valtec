...
class Ordens_m_Orden_Estado extends Model
{
    ...
    public function PendienteOrder($orden_id)
    {
        $data = [
            "estado" => 0
        ];
    ...
    public function aprobarOrden($orden_id)
    {
        $data = [
            "estado" => 0
        ];
    ...
    public function reachazarOrden($orden_id)
    {
        $data = [
            "estado" => 0
        ];
    ...
    public function atenderOrden($orden_id)
    {
        $data = [
            "estado" => 0
        ];
    ...
    public function OrdenCancelada($orden_id)
    {
        $data = [
            "estado" => 0
        ];
    ...
    public function PendienteVerificacion($orden_id)
    {
        $data = [
            "estado" => 0
        ];
