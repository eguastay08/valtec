...
<html>
<head>
    <title>Reporte Listado de Productos Sin Stock</title>
</head>
<style>
...
<body>
    ...
    <div style="width: 95%; margin: 0 auto;">
        ...
        <div style="width: 65%; float:left; margin-right: 10px;">
            <center><h2>REPORTE DE PRODUCTOS SIN STOCK</h2></center>
        </div>
        ...
        <tbody>
            ...
            @foreach ($productos as $producto)
                <tr>
                    ...
                    <td data-column="Sku" style="font-size:13px">{{ $producto->stock }}</td>
                </tr>
                @php($i++)
            @endforeach
        </tbody>
