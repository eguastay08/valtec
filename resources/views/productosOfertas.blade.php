        ...
        <div class="row">
            ...
            <aside class="col-lg-3">
                ...
                <div id="filter-params">
                    ...
                    @if(count($productosxOfertas) > 0)

                        <div class="as-categorias-fitler">
                            <form id="as-categorias-fitler-form" action="{{ url('collections/ofertas') }}" method="get">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 mt-2 px-4">
                                        ...
                                        <input type="hidden" name="preciodOferta" id="preciodOferta" value="{{$precioD != "" ? $precioD : ''}}">
                                        <input type="hidden" name="preciohOferta" id="preciohOferta" value="{{$precioH != "" ? $precioH : ''}}">
            ...
            <article class="col-lg-9">
                    ...
                    <div class="row pb-3">
                        ...
                        <div class="col-md-4 col-sm-6 d-flex justify-content-between align-items-center">
                            ...
                            <select name="SortBy" id="SortBy" class="form-control custom-form-input w-45 ms-3" onchange="location = this.value">
                                <option value="{{url('collections/ofertas?'.$var.'orderProductOferta=defecto')}}" {{$order=='defecto' ? 'selected="selected"' : ''}}>Por defecto</option>
                                <option value="{{url('collections/ofertas?'.$var.'orderProductOferta=precioasc')}}" {{$order=='precioasc' ? 'selected="selected"' : ''}}>Precio Ascendente</option>
                                <option value="{{url('collections/ofertas?'.$var.'orderProductOferta=preciodesc')}}" {{$order=='preciodesc' ? 'selected="selected"' : ''}}>Precio Descendente</option>
                                <option value="{{url('collections/ofertas?'.$var.'orderProductOferta=alfasc')}}" {{$order=='alfasc' ? 'selected="selected"' : ''}}>Alfabéticamente (A-Z)</option>
                                <option value="{{url('collections/ofertas?'.$var.'orderProductOferta=alfdesc')}}" {{$order=='alfdesc' ? 'selected="selected"' : ''}}>Alfabéticamente (Z-A)</option>
                            </select>
                ...
                <div class="row">
                    ...
                    @if(count($productosxOfertas) > 0)
                        ...
                        @foreach($productosxOfertas as $pdata)
                ...
                {{ $productosxOfertas->appends(request()->query())->onEachSide(1)->links('front-partials.pagination-front') }}
