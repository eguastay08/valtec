                                            ...
                                            @foreach($cart_content as $cart)
                                                <tr class="cart__row border-bottom line1 cart-flex border-top">
                                                    ...
                                                    <td class="text-center">
                                                        <button href="#" style="display:inline;" class="btn btn--secondary cart__remove" title="Actualizar Item"><i class="icon icon anm anm-edit"></i></button>                                                    </td>    
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        {{ csrf_field() }}
                                                            ...
                                                            <button href="#" style="display:inline;" class="btn btn--secondary cart__remove" title="Remove tem"><i class="icon icon anm anm-times-l"></i></button>
                    ...
                    <div class="row">
                        ...
                        <div style="cursor:pointer" class="col-12 list-group-item payment-link" onclick="pagoonlined();">
                            <div style="overflow: hidden;">
                                ...
                                <div class="payment-image pull-left">
                                    <img src="{{asset('assets/images/medios_pago_online/mercadopago.png')}}" style="height: 100%">
                                </div>
                                <div class="pull-left payment-text">
