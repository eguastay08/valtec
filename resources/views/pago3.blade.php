                                                    ...
                                                    <div class="form-group pt-15 pb-15 text-center">
                                                        ...
                                                        @foreach($mediosPago as $mp)
                                                            ...
                                                            @if($mp->pago_online==1)
                                                                ...
                                                                <div class="radio-inline" activado ="0">
                                                                    <input type="radio" name="payment" id="payment{{$contador4}}" value="{{$encryptPayMentID}}"  data-payment="{{$mp->nombre}}"  data-value = "{{$mp->data_value}}" online="1" class="input-hidden" onclick="showDescriptionPayment(<?php echo "'".$encryptPayMentID."'"; ?>);">
...
@section('scripts')
    ...
    <script>
        ...
        //     let au64 = 'basic ' +"<?php echo $cadena64; ?>";
        //     if(value == 'izipay')
        //     {
        //         $.ajax({
        //         headers: {
