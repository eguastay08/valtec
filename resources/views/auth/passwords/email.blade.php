              ...
              @csrf
                  <div class="form-group pl-4 pr-4">
                      <div class="input-group">
                          ...
                          <input id="email" placeholder="Ingrese el Email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                          @error('email')
                  ...
                  <div class="mt-3 pl-4 pr-4 pb-2">
                      <button type="submit" class="btn btn-block btn-dark btn-lg font-weight-medium auth-form-btn">Enviar enlace para restablecer contraseña</button>
                  </div>

                  <div class="mt-2 text-center">
                      <a href="/login" class="text-muted">Acceder</a>
                  </div>
            </form>
